...
def init_db():
    ...
    # REMOVED: This block caused rollback of CREATE TABLE users because is_admin already exists in schema.
    # The migration section at the end handles this safely.
    ...
    # Commit table creations before running migrations
    conn.commit()
